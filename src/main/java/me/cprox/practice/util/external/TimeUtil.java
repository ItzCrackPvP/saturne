...
public final class TimeUtil {
    ...
    public static String millisToTimer(long paramLong) {
        long l = paramLong / 1000L;
        return (l > 3600L) ? String.format("%02d:%02d:%02d", new Object[] { Long.valueOf(l / 3600L), Long.valueOf(l % 3600L / 60L), Long.valueOf(l % 60L) }) : String.format("%02d:%02d", new Object[] { Long.valueOf(l / 60L), Long.valueOf(l % 60L) });
    }
