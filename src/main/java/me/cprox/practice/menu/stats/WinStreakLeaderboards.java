...
public class WinStreakLeaderboards extends Menu {
    @Override
    public String getTitle(final Player player) {
        return "&7&lWin Streak Leaderboards";
    }
    ...
    private static class KitLeaderboardsButton extends Button {
        ...
        public ItemStack getButtonItem(final Player player) {
            ...
            lore.add("");
            int position = 1;
            for (KitLeaderboards kitLeaderboards : kit.getWinStreakLeaderboards()) {
    ...
    private static class GlobalLeaderboardsButton extends Button {
        ...
        public ItemStack getButtonItem(final Player player) {
            ...
            lore.add(CC.RED + "Currently not implemented");
