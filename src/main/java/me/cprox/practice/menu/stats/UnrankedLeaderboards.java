...
public class UnrankedLeaderboards extends Menu {
    @Override
    public String getTitle(final Player player) {
        return "&7&lUnranked Leaderboards";
    }
    ...
    private static class KitLeaderboardsButton extends Button {
        ...
        public ItemStack getButtonItem(final Player player) {
            ...
            lore.add("");
            int position = 1;
            for (KitLeaderboards kitLeaderboards : kit.getUnrankedEloLeaderboards()) {
    ...
    private static class GlobalLeaderboardsButton extends Button {
        ...
        public ItemStack getButtonItem(final Player player) {
            ...
            int position = 1;
            lore.add("");
            for (final KitLeaderboards kitLeaderboards : Profile.getGlobalUnrankedEloLeaderboards()) {
                lore.add("&7#" + position + ": &f" + kitLeaderboards.getName() + " &7- " + kitLeaderboards.getElo());
                ++position;
            }
