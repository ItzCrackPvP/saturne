package me.cprox.practice.menu.queue.unranked;
...
public class UnrankedSoloMenu extends Menu {

    @Override
    public String getTitle(Player player) {
        return CC.translate("&7&lSolo Unranked Queue");
    }
    ...
    public Map<Integer, Button> getButtons(Player player) {
        ...
        QueueType queueType = QueueType.UNRANKED;
        ...
        for (Queue queue : Queue.getQueues()) {
            ...
            if (!kit.isEnabled() || !queueType.equals(queue.getType())) continue;
    ...
    private static class SelectKitButton extends Button {
        ...
        public void clicked(Player player, ClickType clickType) {
            ...
            queue.addPlayer(player, (profile.getStatisticsData().get(queue.getKit())).getUnrankedElo());
        }
